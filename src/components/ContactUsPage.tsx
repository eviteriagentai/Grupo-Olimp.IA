        ...
        <div className="relative h-[300px] bg-gradient-to-r from-primary/90 to-primary overflow-hidden">
          ...
          <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center">
            ...
            <p className="text-xl text-white/90 max-w-2xl">
              We're here to help you find your perfect property in Medellín
            </p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  Have questions about our AI property matching? Looking for
                  specific properties in Medellín? Our team is ready to assist
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">+57 604 123 4567</p>
                      <p className="text-gray-600">
                        +57 300 456 7890 (WhatsApp)
                      </p>
                    </div>
                  </div>
                  ...
                  <CardContent className="p-6">
                    ...
                    <form className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          id="message"
                          placeholder="I'm interested in finding a property in El Poblado..."
                          rows={5}
                        />
                      </div>
              ...
              <div className="w-full h-full bg-gray-200 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-500">
                    Calle 10 #43E-31, El Poblado, Medellín, Colombia
                  </p>
                </div>
              </div>
            </div>
